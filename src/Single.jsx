  ...
  return (
    <div className = "container">
      <Card className = "card" body inverse style={{ backgroundColor: '#333', borderColor: '#333' }} >
        ...
        <CardBody>
          <CardTitle className = "title"><b> <font size="6">Restaurant Name</font></b></CardTitle>
